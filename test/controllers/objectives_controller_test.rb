...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post :create, objective: { description: @objective.description, key_focus_area_id: @objective.key_focus_area_id, name: @objective.name }
    end
  ...
  test "should update objective" do
    patch :update, id: @objective, objective: { description: @objective.description, key_focus_area_id: @objective.key_focus_area_id, name: @objective.name }
    assert_redirected_to objective_path(assigns(:objective))
  end
